                ...
                body: SizedBox(
                  ...
                  child: Column(
                    children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  child: Text(
                                    '${studentProvider.filtredStudent?.length}',
                      ...
                      Expanded(
                        child: studentProvider.statusCode == 200
                            ? Container(
                            ...
                            : studentProvider.statusCode == 404
                            ? Center(
                                child: Text('لا يوجد تلاميذ متاحون', style: TextStyle(fontSize: width * 0.05)),
                              )
                            : studentProvider.statusCode == 0
