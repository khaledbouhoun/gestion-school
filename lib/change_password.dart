      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Center(
            child: Text(
              'تغيير كلمة السر',
              style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: width * 0.07),
            ),
          ),
        ),
        body: Container(
            ...
            children: [
              ...
              TextButton(
                ...
                child: Container(
                  ...
                  child: authProvider.changePasswordStatusCode != 0
                      ? Text(
                          "تأكيد",
      ...
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            obscureText: hiding == 1
                ? authProvider.currentPasswordHiding
                : hiding == 2
                ? authProvider.newPasswordHiding
                : authProvider.conformPasswordHiding,
      ...
      if (newPassword.text == '') {
        ...
        if (confirmedPassword.text == '') {
          ...
          if (current != authProvider.selectedUser!.USRPASSW) {
            Toast(
              context: context,
              title: 'كلمة السر الحالية غير صحيحة',
            ...
            if (newPassword.text != confirmedPassword.text) {
              Toast(
                context: context,
                title: 'كلمة المرور المأكدة غير متطابقة',
                style: ToastificationStyle.minimal,
                type: ToastificationType.warning,
              );
            } else {
