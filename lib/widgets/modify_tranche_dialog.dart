...
class ModifyTrancheDialogPage extends State<ModifyTrancheDialog> with Quran {
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                onChanged: (String? sura) async {
                                  ...
                                  trancheProvider.modifiedTranche?.TRCSOURADE =
                                      int.parse(sura!);
                            ...
                            Container(
                              ...
                              child: DropdownButton<int>(
                                value:
                                    trancheProvider.modifiedTranche!.TRCAYADE,
                                underline: Container(),
                                isExpanded: true,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButton<String>(
                                ...
                                onChanged: (String? sura) async {
                                  ...
                                  trancheProvider.modifiedTranche?.TRCSOURAA =
                                      int.parse(sura!);
                                  trancheProvider.notifyListeners();
                                },
                                items: surat.map<DropdownMenuItem<String>>((
                            ...
                            Container(
                              ...
                              child: DropdownButton<int>(
                                ...
                                isExpanded: true,
                                onChanged: (int? aya) async {
                                  trancheProvider.modifiedTranche?.TRCAYAA =
                                      aya;
                                  trancheProvider.notifyListeners();
                                },
                                items: ayat
                        ...
                        Center(
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              await modifyTranche(context);
                            },
                            child: trancheProvider.modifyStatusCode != 0
                                ? Text(
                                    "موافق",
                                    style: TextStyle(
                                      fontSize: width * 0.05,
  ...
  Future<void> modifyTranche(BuildContext context) async {
    var trancheProvider = Provider.of<TrancheViewModel>(context, listen: false);
    if (trancheProvider.modifiedTranche?.TRCSENS == 1 &&
        (trancheProvider.modifiedTranche!.TRCSOURADE! <
            trancheProvider.modifiedTranche!.TRCSOURAA!)) {
      Toast(
        context: context,
    ...
    } else if (trancheProvider.modifiedTranche?.TRCSENS == 2 &&
        (trancheProvider.modifiedTranche!.TRCSOURADE! >
            trancheProvider.modifiedTranche!.TRCSOURAA!)) {
      Toast(
        context: context,
    ...
    } else if ((trancheProvider.modifiedTranche!.TRCSOURADE! ==
            trancheProvider.modifiedTranche!.TRCSOURAA!) &&
        (trancheProvider.modifiedTranche!.TRCAYADE! >
            trancheProvider.modifiedTranche!.TRCAYAA!)) {
      Toast(
