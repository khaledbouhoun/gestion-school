                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: DropdownButton<User>(
                                        ...
                                        hint: provider.users!.isEmpty
                                            ? Text("لا يوجد أساتذة")
                                            : Text(
                                                provider.selectedUser!.USRLOGIN,
                                              ),
                                        underline: Container(),
                                        isExpanded: true,
                                ...
                                TextButton(
                                  ...
                                  onPressed: () async {
                                    if (password.text == '') {
                                      ...
                                      Digest convertedBytes = md5.convert(
                                        bytes,
                                      );
                                      String hashed = convertedBytes
                                          .toString()
                                          .toUpperCase();
                                      if (hashed ==
                                          provider.selectedUser!.USRPASSW) {
                                        if (provider.selectedUser!.USRETAT ==
                                            1) {
                                          ...
                                          if (provider.loginStatusCode == 404) {
                                            Toast(
                                              context: context,
                                              title:
                                                  'لا توجد صلاحيات لملف ${provider.selectedFolder!.DOSNOM}',
                                              style:
